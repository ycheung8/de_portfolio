...
```
Wrap the above pipelines into a preprocessor object that includes steps for (A) processing the numerical columns and (B) processing the categorical columns.
```
